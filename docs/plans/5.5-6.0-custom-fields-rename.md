...
**Status:** In Progress — 5.4 serializer bridge shipped; 5.5 CRUD API + SDK + alias classes shipping; 6.0 model rename pending
**Target:** 5.4 (Store API serializer bridge, shipped) + 5.5 (Admin CRUD API + SDK + `Spree::CustomField` constant alias) + 6.0 (model/table rename + visibility simplification + STI rename)
